package net.finestgit.mccourse;

import net.finestgit.mccourse.block.ModBlocks;
import net.finestgit.mccourse.item.ModCreativeModeTabs;
...
public class MCCourseMod {
    ...
    @EventBusSubscriber(modid = MCCourseMod.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
